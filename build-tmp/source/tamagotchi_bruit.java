...
public class tamagotchi_bruit extends PApplet {
...
int side= (int)random(15,20); //g\u00e9rer le nombre de edge/pics
int rayon=(int)random(130,131); //taille de stain
float rayonProtected = 115; //si on veut une forme "plus ronde" il faut changer cette valeur vers le haut
...
class polygon {
  ...
  public polygon trace() {
    ...
    if (debug) {
      ...
      strokeWeight(0.5f);
      //stroke(0);
      fill(180,90,255); //l'humeur peut aussi \u00eatre g\u00e9r\u00e9r par la couleur par la suite (red,green,blue)
    }
    else {
      strokeWeight(1);
      stroke(0);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "tamagotchi_bruit" };
    if (passedArgs != null) {
